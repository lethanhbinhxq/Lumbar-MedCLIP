...
class MedCLIPModel(nn.Module):
    ...
    def encode_text(self, input_ids=None, attention_mask=None, use_projection=False):
        ...
        text_embeds = self.text_model(input_ids, attention_mask, use_projection=use_projection)
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        img_embeds = self.encode_image(pixel_values, use_projection)
        text_embeds = self.encode_text(input_ids, attention_mask, use_projection)
